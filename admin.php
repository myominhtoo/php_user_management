                    ...
                    <tr>
                        ...
                        <td class="d-flex gap-1">
                            <div class="dropdown" id="dropdown">
                                <a href="" class="dropdown-toggle btn btn-primary btn-sm mx-1 <?php if($adminPower || $user->id == $auth['id']){ echo 'disabled'; }?>" data-bs-toggle="dropdown" href="#dropdown">Change Role</a>
                                <ul class="dropdown-menu p-0 m-0 fw-bold">
                                   ...
                                   <li><a href="./actions/role.php?id=<?php echo $user->id; ?>&role=4" class="dropdown-item">Manager</a></li>
                                    <!-- will give chance to change role to admin for only admin -->
